...
public class CreatedBoard {
    ...
    public CreatedBoard(String id, String name, String desc, Object descData, Boolean closed, String idOrganization, Object idEnterprise, Boolean pinned, String url, String shortUrl, Prefs prefs, LabelNames labelNames, Limits limits) {
        super();
        this.id = id;
        this.name = name;
        this.desc = desc;
